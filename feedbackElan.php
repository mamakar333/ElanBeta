...
<html>
   <head>
      ...
      <title>Feedback Elan Workshop</title>
   </head>
  ...
  fjs.parentNode.insertBefore(js, fjs);
                  ...
                  <div class="container container-table">
                     <div class="row vertical-center-row">
                        <div class="text-center col-md-6 col-md-offset-3">
                           <h1 id="title" >Elan Workshop Feedback Form</h1>
                        </div>
            ...
            <tr>
               ...
               <td style="border:none;"  width="100">
                  ...
                  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="form-inline" name="feedback">
                     ...
                     <br><br>
                     <label class="control-label" for="usr">Topic:</label>
                     <div class="input-group">
                        <input type="text" class="form-control" id="usr" name="topic" value="<?php echo $topic; ?>" required >
      ...
      <div id=footerwrap1>
         <div class=container>
            ...
            &nbsp;&nbsp;&nbsp;
             <a href=https://www.facebook.com/groups/elan.iit.hyderabad/ target=_blank><i class="fa fa-facebook"></i></a>
             &nbsp;&nbsp;&nbsp;
 <!--
