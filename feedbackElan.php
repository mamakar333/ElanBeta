...
$nameErr = $collegeErr = $dateOfWorkshopErr = $collegeWhereErr = $contactErr = $emailErr = $topicErr =  $rateErr = "";
$name = $college  = $dateOfWorkshop = $collegeWhere = $contact = $email = $topic = $comment = $rate = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["topic"])) {
    $topicErr = "<br><br>Topic of Workshop is required";
    $flag = 0;
  } else {
    $topic = test_input($_POST["topic"]);
    // check if name only contains letters and whitespace
    if (!preg_match("/^[a-zA-Z0-9 ]*$/",$topic)) {
      $topicErr = "<br><br>Only letters and white space allowed";
      $flag = 0;
    }
...
<div class="container container-table">
  <div class="row vertical-center-row">
    <div class="text-center col-md-5 col-md-offset-3">
      <h2>ELAN WORKSHOP <br>FEEDBACK FORM</h2>
      <hr>
      ...
      <fieldset div="container-fluid">
        <div class="row">
          <label class="control-label col-sm-3" for="usr" style="margin-left:-15px;">&nbsp;E-mail:</label>
          <input type="email" class="col-sm-8" id="usr" style="margin-left: 15px;" name="email" value="<?php echo $email;?>" required >
        ...
        <fieldset div="container-fluid">
          <div class="row">
            <label class="control-label col-sm-2" for="usr">Topic:</label>
            <input type="text" class="col-sm-9" id="usr" name="topic" value="<?php echo $topic;?>" required>
        ...
        <fieldset div="container-fluid">
         ...
         <fieldset div="container-fluid">
           <label class="control-label col-sm-4" for="sel1" style="margin-left:-15px;">Rate Out Of 10: </label>
